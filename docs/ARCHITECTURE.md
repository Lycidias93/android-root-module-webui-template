...
For the normal Action path, the launcher closes server stdin, inherits SIGHUP=ignore into the server, and the server does not re-subscribe to SIGHUP; this makes SIGHUP
